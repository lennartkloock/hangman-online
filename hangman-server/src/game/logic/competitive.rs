...
//     players_guard
//         .send_to_all(ServerMessage::UpdateGame(Game::Results(scores)))
//         .await;
// }
...
pub async fn game_loop(
    ...
    //                 None => {
    //                     sender
    //                         .log_send(ServerMessage::UpdateGame(Game::InProgress {
    ...
    //                 Some(r) => {
    //                     sender
    //                         .log_send(ServerMessage::UpdateGame(Game::Results(r.clone())))
    //                         .await;
    //                 }
    //             }
    //
    ...
    //                         guard
    //                             .send_to_all(ServerMessage::UpdateGame(Game::InProgress {
    //                                 settings: settings.clone(),
    //                                 state: GameState::Playing,
